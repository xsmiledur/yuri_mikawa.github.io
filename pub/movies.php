...
<body>
    ...
    <div class="container pt">
        ...
        <!--<iframe width="560" height="315" src="https://www.youtube.com/embed/9X66YZTb_hA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>-->
            ...
            foreach ($dbh->query('SELECT * FROM movies') as $row) {
                ...
                echo '<div col-lg-6 col-lg-offset-3 style="text-align:center;">';
                echo '<p><bd>', $row['date'], '</bd></p>';
                echo '<h4>',$row['title-j'],'</h4>';
                echo $row['description-j'],'<br><br>';
                echo $row['script'];
                echo '</div><hr>';
                echo '</div>';
                ++$cnt;
